...
export function createPlayerEnteredEvent(
  player: Address,
  gameId: BigInt
): PlayerEntered {
  let playerEnteredEvent = changetype<PlayerEntered>(newMockEvent())

  playerEnteredEvent.parameters = new Array()

  playerEnteredEvent.parameters.push(

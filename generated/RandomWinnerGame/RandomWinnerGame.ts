...
export class PlayerEntered extends ethereum.Event {
  get params(): PlayerEntered__Params {
    return new PlayerEntered__Params(this);
  }
}

export class PlayerEntered__Params {
  _event: PlayerEntered;

  constructor(event: PlayerEntered) {
    this._event = event;
  }
